...
class QJL:
    ...
    def quantize(self, x):
        ...
        """
        z = np.sign(self.S @ x)
        # Handle the (extremely rare) case where S·x has a zero entry
        z[z == 0] = 1.0
        return z
...
if __name__ == "__main__":
    ...
    print(f"  Arc-cosine kernel: E[raw estimate] = 2/pi · <x,y>  (before dequant scaling)")
    print(f"  D_prod (inner product distortion) ≤ π/(2d) · ||y||²  (QJL Lemma 2)")
    print()
